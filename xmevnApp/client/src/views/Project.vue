<template>
    <div>
        <!-- <dashboard> -->
        <header-title title="Project |MixPersonal" />
        <!-- </dashboard> -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>This project will be a search application for all films around the world complete with
                                all film descriptions such as directors, actors, metascore and even the income from the
                                film.</p>
                        </div>
